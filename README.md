...
## FAQs<a name ="faq"></a>
 ...
 - How can I tell if I have Java installed?
    - Open the command prompt (*Note:* This can be done by pressing <img src="https://github.com/beechd/beechd.github.io/blob/master/images/windowsKey.png"> + R then running "cmd").
